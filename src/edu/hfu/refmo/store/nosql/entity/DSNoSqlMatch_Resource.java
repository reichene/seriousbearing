...
@Subclass(index=true)
public class DSNoSqlMatch_Resource extends  DSNoSqlMatch{

	public DSNoSqlMatch_Resource() {
		super();
	
	}

	public DSNoSqlMatch_Resource(String attribute_name, String attribute_value,
